			...
			<view class="evaluate-card">
				...
				<!-- 教师寄语展示 -->
								<view class="section" v-if="teacherContent !== null">
									<text class="section-title">教师寄语</text>
				...
				<view class="section">
					...
					<u--textarea v-model="formData.content" placeholder="您可以从学习、生活习惯、成长等方面对孩子进行评价." height="200"
						maxlength="200" count border="none" class="textarea"></u--textarea>
				</view>
				<!-- 提交按钮 -->
				<u-button type="primary" shape="circle" @click="handleSubmit" :disabled="!formData.content"
					class="submit-btn">
