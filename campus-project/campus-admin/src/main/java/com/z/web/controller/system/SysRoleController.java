...
import com.z.framework.web.service.SysPermissionService;
import com.z.framework.web.service.TokenService;
...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role)
    {
        ...
        if (roleService.updateRole(role) > 0)
        {
            ...
            {
                loginUser.setUser(userService.selectUserByUserName(loginUser.getUser().getUserName(), null));
