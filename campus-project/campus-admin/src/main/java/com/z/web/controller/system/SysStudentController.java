...
public class SysStudentController extends BaseController {
     ...
     * 获取学生信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:report:studentReport')")
    @GetMapping(value = "/studentReport")
    public AjaxResult selectStudentReportById(Long studentId, String semesterId) {
        return success(sysStudentService.selectStudentReportById(studentId, semesterId));
    }
}
